<template>
    ...
    <div v-for="(condition, index) in conditions" :key="index">
        ...
        <div v-if="isNone(index)">NOOONE
            <hr>
        </div>
        <div v-if="isDebounce(index)"> Debounce set every {{ getTimeText(condition) }}
            <hr>
        </div>
...
function isNone(condition) { return condition === 'None' }
function isDebounce(condition) { return condition === 'debounce' }
function isArrDep(condition) { return condition === 'ArrDep' }
function isMoreFancey(condition) { return condition === 'moreFancey' }
